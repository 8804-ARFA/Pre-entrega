...
function generarListaProductos() {
    const listaProductosDiv = document.querySelector('.lista-de-productos');
    ...
    productos.forEach(producto => {
        ...
        productoDiv.innerHTML = `
            <img class="Productos-img" src="${producto.imagen}" alt="${producto.nombre}">
            ...
            <button class="agregar" data-product="${producto.id}" data-price="${producto.precio}">Agregar</button>
            `;
